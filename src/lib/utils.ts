...
export const SERVICE_COLOURS: Record<string, string> = {
  ...
  'Identity': 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300',
  'DevOps': 'bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300',
  'Database': 'bg-violet-100 text-violet-700 dark:bg-violet-900/40 dark:text-violet-300',
  'Email': 'bg-pink-100 text-pink-700 dark:bg-pink-900/40 dark:text-pink-300',
  'Gateway': 'bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300',
  'Governance': 'bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300',
};
...
// Colours for the 12 service categories
...
// Macro theme groupings for Dashboard charts (18 guidelines → 5 themes)
export const MACRO_THEME_MAP: Record<string, string> = {
  'Guidelines for cyber security roles': 'Governance & People',
  'Guidelines for cyber security incidents': 'Governance & People',
  'Guidelines for procurement and outsourcing': 'Governance & People',
  'Guidelines for cyber security documentation': 'Governance & People',
  'Guidelines for personnel security': 'Governance & People',
  'Guidelines for physical security': 'Governance & People',
  'Guidelines for evaluated products': 'Governance & People',
  'Guidelines for system hardening': 'Technical Controls',
  'Guidelines for system management': 'Technical Controls',
  'Guidelines for system monitoring': 'Technical Controls',
  'Guidelines for cryptography': 'Technical Controls',
  'Guidelines for software development': 'Technical Controls',
  'Guidelines for database systems': 'Technical Controls',
  'Guidelines for networking': 'Network & Comms',
  'Guidelines for gateways': 'Network & Comms',
  'Guidelines for communications infrastructure': 'Network & Comms',
  'Guidelines for communications systems': 'Network & Comms',
  'Guidelines for email': 'Network & Comms',
  'Guidelines for data transfers': 'Network & Comms',
  'Guidelines for information technology equipment': 'Technical Controls',
  'Guidelines for media': 'Technical Controls',
};

export const MACRO_THEME_COLOURS: Record<string, string> = {
  'Governance & People': '#f59e0b',
  'Technical Controls': '#3b82f6',
  'Network & Comms': '#0ea5e9',
};
...
export const SERVICE_TOOLTIPS: Record<string, string> = {
  ...
  'Amazon Aurora': 'MySQL/PostgreSQL-compatible relational database from AWS',
  'Amazon DynamoDB': 'Fully managed NoSQL database service on AWS',
  'AWS Backup': 'Centralised backup service across AWS resources',
  'AWS Network Firewall': 'Managed network firewall for VPC traffic inspection',
  'Route 53': 'Scalable DNS and domain registration service from AWS',
  'Route 53 Resolver': 'DNS resolution for hybrid cloud environments on AWS',
  'AWS VPN': 'Managed VPN connection between on-premises and AWS',
  'AWS CodeBuild': 'Fully managed continuous integration service on AWS',
  'AWS CodeCommit': 'Managed source control service on AWS',
  'AWS CodeArtifact': 'Managed artifact repository service on AWS',
  'Amazon CodeGuru': 'ML-powered code review and application performance tool',
  'Microsoft Defender for DevOps': 'Security management across DevOps pipelines in Azure',
  'Microsoft Defender for Office 365': 'Protection for email and collaboration tools in Microsoft 365',
  'Azure Artifacts': 'Package management for Maven, npm, NuGet, Python in Azure DevOps',
  'Azure SQL Database': 'Fully managed relational database service in Azure',
  'Azure Cosmos DB': 'Globally distributed multi-model database service in Azure',
  'Azure Database for PostgreSQL': 'Managed PostgreSQL database service in Azure',
  'Azure Backup': 'Centralised backup service for Azure and on-premises resources',
  'Azure Firewall': 'Managed cloud-native network security service in Azure',
  'Network Security Groups': 'Layer 4 traffic filtering for Azure Virtual Network resources',
  'Security Groups': 'Virtual firewall for controlling inbound/outbound traffic on AWS',
  'Azure DNS': 'Hosting service for DNS domains in Azure',
  'Azure Private DNS': 'DNS resolution within Azure virtual networks',
  'Azure VPN Gateway': 'Managed VPN connectivity between Azure and on-premises networks',
  'Azure Communication Services': 'Cloud-based communication APIs for SMS, voice, and chat in Azure',
  'Amazon WorkMail': 'Managed business email and calendar service on AWS',
  'Amazon SES': 'Scalable email sending service from AWS',
  'Amazon Chime': 'Communications service for meetings, chat, and business calling on AWS',
  'AWS Transfer Family': 'Managed file transfer service for SFTP, FTPS, FTP on AWS',
  'AWS DataSync': 'Automated data transfer service between on-premises and AWS',
  'Azure Data Factory': 'Data integration and ETL service in Azure',
  'Azure File Sync': 'Centralises file shares in Azure while maintaining local access',
  'Azure Compliance Manager': 'Risk assessment tool for compliance management in Azure',
  'Azure Application Gateway': 'Layer 7 load balancer with WAF capability for Azure',
  'Azure Resource Graph': 'Service for exploring and querying Azure resources at scale',
  'Azure VM Image Builder': 'Automated VM image creation and customisation in Azure',
  'ALB': 'AWS Application Load Balancer — layer 7 load balancer with advanced routing',
  'AWS Elastic Beanstalk': 'PaaS for deploying and scaling web applications on AWS',
};
